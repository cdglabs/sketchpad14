...
// --- Constraints ---------------------------------------------------------
	...
	if (mass > 0) {
	    ...
	    rc.addConstraint(Sketchpad.simulation.AccelerationRelation, undefined, body, new Vector(0, 0.8)) //gravity
    ...
    rc.addConstraint(Sketchpad.geom.MotorMotion, undefined, p1, p2, 1)

    rc.addConstraint(Sketchpad.simulation.BounceBehavior, undefined, rocket, wall2.p1, wall2.p2)
    rc.addConstraint(Sketchpad.simulation.BounceBehavior, undefined, bodies[1], wall2.p1, wall2.p2)
    rc.addConstraint(Sketchpad.simulation.AccelerationRelation, undefined, rocket, {x: 0, y: Sketchpad.simulation.g})
