...
// --- Constraints ---------------------------------------------------------
    ...
    // score boards
    var goodWords = rc.add(new TextBox(new Point(150, 100), undefined, true, 22, 150, 500, undefined, undefined, 'green'))
    var badWords = rc.add(new TextBox(new Point(350, 100), undefined, true, 22, 150, 500, undefined, undefined, 'red'))
