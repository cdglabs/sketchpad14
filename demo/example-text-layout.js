...
// --- Constraints ---------------------------------------------------------
    ...
    rc.setOption('onlyRenderOnConvergence', true)
...
// --- Data ----------------------------------------------------------------
    rc.add(new TextBox(new Point(400, 50), 'Press "Option/Alt" to toggle word-wrap mode:', 20, 420, 40, '#81f781'))
    modeLabel = rc.add(new TextBox(new Point(830, 50), ('"' + sketchpad.scratch.wordWrapModes[sketchpad.scratch.wordWrapMode] + '"'), 20, 90, 40, '#f6ceec'))
    textArea = rc.add(new Examples.textlayout.TextArea(22, 10, new Box(rc.add(new Point(200, 200, 'gray', 6)), 850, 400, true, undefined, '#f0ee9e'))).init()
