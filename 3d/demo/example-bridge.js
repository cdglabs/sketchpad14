examples['bridge']= function() {
	...
	if (mass > 0) {
	    var body = bodies[i]
	    rc.addConstraint(Sketchpad.simulation3d.VelocityRelation, undefined, body)
	    rc.addConstraint(Sketchpad.simulation3d.AccelerationRelation, undefined, body, new Vector3D(0,
											       //-Sketchpad.simulation.g
											       -1
											       , 0)) //gravity
	    //rc.addConstraint(Sketchpad.simulation3d.AirResistanceConstraint, undefined, body, 0.00001)
	    rc.addConstraint(Sketchpad.simulation3d.AccelerationRelation, undefined, body, body.acceleration) //spring force
	    rc.addConstraint(Sketchpad.simulation3d.VelocityAsLineSegmentRelation, undefined, body, wind) //wind 
	}
    }
	...
	var body1 = bodies[end1]
	var body2 = bodies[end2]
	rc.addConstraint(Sketchpad.simulation3d.Springiness, undefined, body1, body2, spring)
    }
