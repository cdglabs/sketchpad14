...
function Cylinder(p1, p2, optColor, optWidth, optLineDash, optOpacity) {
    ...
    var height = Sketchpad.geom3d.distance(this.p1, this.p2)
    this._sceneObj = new THREE.Mesh(new THREE.CylinderGeometry( this.width, this.width, height), 
				    new THREE.MeshLambertMaterial({color: this.color}))
    this._sceneObj.position.set(mid.x, mid.y, mid.z)
    this.setAngleBasedOnEndPoints()
}

Cylinder.prototype.setAngleBasedOnEndPoints = function() {
